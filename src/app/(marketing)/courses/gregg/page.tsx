...
export default function GreggComingSoonPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="max-w-lg text-center">
        ...
        >
          We&apos;re building an in-depth Gregg shorthand course with interactive
          lessons, stroke animations, and practice exercises. Coming soon!
        </motion.p>
        ...
        >
          ...
          <span>Estimated launch: Q4 2026</span>
        </motion.div>
